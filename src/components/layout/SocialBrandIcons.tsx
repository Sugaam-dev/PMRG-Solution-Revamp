...
export function WhatsAppBrandIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} style={{ color: "#25D366" }} aria-hidden="true">
...
export function InstagramBrandIcon({ className }: IconProps) {
  ...
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      ...
      <rect x="3" y="3" width="18" height="18" rx="5" fill="none" stroke={`url(#${gradientId})`} strokeWidth="2" />
      <circle cx="12" cy="12" r="3.4" fill="none" stroke={`url(#${gradientId})`} strokeWidth="2" />
