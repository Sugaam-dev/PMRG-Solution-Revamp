      ...
      <AnimatePresence mode="wait">
        {!open ? (
          <motion.button
            ...
            aria-label="Search"
            className={cn(
              "flex h-10 w-10 items-center justify-center rounded-lg border transition-colors lg:h-7 lg:w-7 lgx:h-[1.875rem] lgx:w-[1.875rem] xl:h-8 xl:w-8 2xl:h-9 2xl:w-9",
              isOverLight
