        ...
        <div className="container-pmrg grid grid-cols-1 gap-6 lg:grid-cols-12">
          <Reveal className="lg:col-span-7">
            <GlassCard theme="light" strong className="relative overflow-hidden p-7 sm:p-9">
              <h2 className="relative text-xl font-semibold text-fg-dark">
            ...
            <div className="flex h-full flex-col gap-5">
                ...
                <ul className="mt-5 space-y-4">
                  <li className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-sm text-fg-dark hover:text-brand"
                      >
                        {COMPANY.email}
                      </a>
                    </div>
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm leading-relaxed text-fg-dark">
                        {COMPANY.address}
                      </p>
                    </div>
                  </li>
              ...
              <GlassCard theme="light" className="p-7">
                ...
                <p className="mt-4 text-sm leading-relaxed text-fg-dark-muted">
                  PMRG will review the enquiry, identify the relevant capability owner and
                  contact you using the information provided.
                </p>
              </GlassCard>
            </div>
          </Reveal>
